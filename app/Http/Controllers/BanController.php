...
class BanController extends Controller
{
    ...
    /**
     * VotePen administrator banning a user (bans everwhere and has more consequences).
     *
     * @param \Illuminate\Http\Request $request
     *
     * @return response
     */
    public function storeAsVotePenAdministrator(Request $request)
    {
        $this->validate($request, [
            'username'    => ['required', 'exists:users', new NotSelfUsername()],
     ...
     * @return \Illuminate\Support\Collection
     */
    public function indexAsVotePenAdministrator(Request $request)
    {
        return BannedUserResource::collection(
     ...
     * @return response
     */
    public function destroyAsVotePenAdministrator(Request $request)
    {
        $this->validate($request, [
            'user_id' => 'required|exists:users,id',
        ]);
