<template>
    <section class="home-wrapper" v-once>
        ...
        <section id="page" class="home-submissions credits">
            <p>
                VotePen would like to thank the authors of the following open source components and third party services that contributed essential functionality to our applications:
            </p>
                ...
                <div class="item">
                    <h3>
                        <a href="http://php.net/" rel="nofollow">
                            <img src="https://cdn.jsdelivr.net/npm/votepen-cdn@1.0.0-beta/landing/credits/php.png" alt="PHP7">
                        </a>
                    </h3>
                ...
                <div class="item">
                    <h3>
                        <a href="https://laravel.com/" rel="nofollow">
                            <img src="https://cdn.jsdelivr.net/npm/votepen-cdn@1.0.0-beta/landing/credits/laravel.png" alt="laravel">
                        </a>
                    </h3>
                ...
                <div class="item">
                    <h3>
                        <a href="https://vuejs.org/" rel="nofollow">
                            <img src="https://cdn.jsdelivr.net/npm/votepen-cdn@1.0.0-beta/landing/credits/vue.jpg" alt="vue">
                        </a>
                    </h3>
                ...
                <div class="item">
                    <h3>
                        <a href="http://element.eleme.io/#/en-US" rel="nofollow">
                            <img src="https://cdn.jsdelivr.net/npm/votepen-cdn@1.0.0-beta/landing/credits/element.jpg" alt="Element">
                        </a>
                    </h3>

                    <div>
                        <p>
                            Element is a Chinese JavaScript and CSS library based on Vue 2.0. 
                        </p>

                        <p>
                            Element simplifies writing Vue codes by letting developers to focus on what's really important: the logic. 
                        </p>
                    </div>
                </div>
                ...
                <div class="item">
                    <h3>
                        <a href="http://www.mysql.com" rel="nofollow">
                            <img src="https://cdn.jsdelivr.net/npm/votepen-cdn@1.0.0-beta/landing/credits/mysql.png" alt="mysql">
                        </a>
                    </h3>
                ...
                <div class="item">
                    <h3>
                        <a href="https://www.algolia.com/referrals/fb684d54/join" rel="nofollow">
                            <img src="https://cdn.jsdelivr.net/npm/votepen-cdn@1.0.0-beta/landing/credits/algolia.svg">
                        </a>
                    </h3>
                ...
                <div class="item">
                    <h3>
                        <a href="https://nodejs.org/en/" rel="nofollow">
                            <img src="https://cdn.jsdelivr.net/npm/votepen-cdn@1.0.0-beta/landing/credits/node.png" alt="nodeJS">
                        </a>
                    </h3>
                    <div>
                        <p>
                ...
                <div class="item">
                    <h3>
                        <a href="http://socket.io/" rel="nofollow">
                            <img src="https://cdn.jsdelivr.net/npm/votepen-cdn@1.0.0-beta/landing/credits/socket.png" alt="socket">
                        </a>
                    </h3>
                ...
                <div class="item">
                    <h3>
                        <a href="https://nginx.org/" rel="nofollow">
                            <img src="https://cdn.jsdelivr.net/npm/votepen-cdn@1.0.0-beta/landing/credits/nginx.png" alt="nginx">
                        </a>
                    </h3>
